...
class LanguageProcessing:
    ...
    def clean_data(self, text):
        ...
        stripped = [self.punctuation_removal.sub('', token) for token in tokens if token]
        words = [self.get_lemma(word) for word in stripped if word.isalpha() and word not in self.stop_words]
